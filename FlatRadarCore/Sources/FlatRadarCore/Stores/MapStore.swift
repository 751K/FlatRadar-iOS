...
public final class MapStore {
    ...
    public init() {}
    public var listings: [MapListing] = []
    public var uncached: Int = 0
    ...
    public var activeStatuses: Set<ListingStatus> =
    ...
    public var focusExtra: MapListing?
    /// 说明为什么它不在图上。nil 表示没有要说的。
    public var focusNotice: FocusNotice?

    public enum FocusNotice: Equatable, Sendable {
        ...
        public var text: String {
            switch self {
            case .outOfView:
                return String(localized: "This listing is outside the current map view (past the freshness window or excluded by filters). Its location is marked below.", bundle: .module)
            case .noCoords:
                return String(localized: "This listing's address has not been geocoded yet, so it has no position on the map.", bundle: .module)
            case .notFound:
                return String(localized: "This listing could not be found; the link may have expired.", bundle: .module)
            }
        }
    ...
    public var selected: MapListing? {
    ...
    public struct EmptyBreakdown: Equatable, Sendable {
        /// 被关掉的状态档 → 各有几套，按数量降序。
        public var byStatus: [(status: ListingStatus, count: Int)]
        /// 状态这一关过了，却被城市 / 平台 / 租金 / 面积挡下的条数。
        public var byOtherFilters: Int
    ...
    public var emptyBreakdown: EmptyBreakdown {
    ...
    public func focus(on id: String) async {
        focusID = id
        focusExtra = nil
        focusNotice = nil
