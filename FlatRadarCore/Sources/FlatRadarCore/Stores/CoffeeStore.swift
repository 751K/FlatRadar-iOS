...
public final class CoffeeStore {
    ...
    /// 见其它 store：隐式 init 随 `public` 变 internal，宿主构造不了。
    public init() {}
    ...
    public var showThanks = false
    public var thanksMessage = ""
        ...
        do {
            ...
            case .success(let verification):
                ...
                case .verified(let tx):
                    ...
                    showThanks = true
                case .unverified:
                    purchaseError = String(localized: "Transaction verification failed.", bundle: .module)
                }
            case .userCancelled:
                break
            case .pending:
                purchaseError = String(localized: "Payment is pending approval.", bundle: .module)
            @unknown default:
                break
            }
        } catch {
