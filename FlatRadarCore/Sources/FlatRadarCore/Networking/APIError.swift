...
extension APIError: LocalizedError {
    public var errorDescription: String? {
        switch self {
        case .unauthorized: return String(localized: "Login Failed", bundle: .module)
        case .forbidden:    return String(localized: "Access Denied", bundle: .module)
        case .notFound:     return String(localized: "Not Found", bundle: .module)
        case .validation:   return String(localized: "Invalid Request", bundle: .module)
        case .conflict:     return String(localized: "Conflict", bundle: .module)
        case .rateLimited:  return String(localized: "Too Many Requests", bundle: .module)
        case .serverError:  return String(localized: "Server Error", bundle: .module)
        case .network:      return String(localized: "Connection Failed", bundle: .module)
        case .decoding:     return String(localized: "Data Error", bundle: .module)
        case .badResponse:  return String(localized: "Unexpected Response", bundle: .module)
        }
    }
    ...
    public var failureReason: String? {
        ...
        case .network(let err):      return String(localized: "Network error: \(err.localizedDescription)", bundle: .module)
        case .decoding:              return String(localized: "The server returned data in an unexpected format.", bundle: .module)
        case .badResponse(let code): return String(localized: "Server returned HTTP \(code)", bundle: .module)
        }
    }

    public var recoverySuggestion: String? {
        switch self {
        case .unauthorized: return String(localized: "Please sign in again.", bundle: .module)
        case .forbidden:    return String(localized: "You don't have permission to access this.", bundle: .module)
        case .network:      return String(localized: "Check your internet connection and try again.", bundle: .module)
        case .serverError:  return String(localized: "Please try again later.", bundle: .module)
        case .rateLimited:  return String(localized: "Please wait a moment before retrying.", bundle: .module)
        case .notFound:     return String(localized: "It may have been removed.", bundle: .module)
        case .conflict:     return String(localized: "Try a different value.", bundle: .module)
