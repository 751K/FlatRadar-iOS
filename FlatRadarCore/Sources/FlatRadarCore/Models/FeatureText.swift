...
public nonisolated enum FeatureText {
    ...
    public static func displayOccupancy(_ value: String) -> String {
    ...
    /// 用的是同一套判断。
    public static func display(_ value: String, forKey key: String) -> String {
        let k = key
    ...
    public static func displayType(_ value: String) -> String {
        let trimmed = value.trimmingCharacters(in: .whitespacesAndNewlines)
