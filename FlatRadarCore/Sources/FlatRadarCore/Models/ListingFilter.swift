...
public nonisolated struct ListingFilter: Codable, Equatable, Sendable {
    public var maxRent: Double?
    public var minArea: Double?
    public var minFloor: Int?
    public var allowedOccupancy: [String]
    public var allowedTypes: [String]
    public var allowedNeighborhoods: [String]
    public var allowedCities: [String]
    public var allowedSources: [String]
    public var allowedContract: [String]
    public var allowedTenant: [String]
    public var allowedOffer: [String]
    public var allowedFinishing: [String]
    public var allowedEnergy: String
    ...
    public static let empty = ListingFilter(
    ...
    public var summaryChips: [SummaryChip] {
    ...
    ///   选项在两屏上叫两个名字。
    public static nonisolated func brief(_ values: [String], label: String? = nil,
...
/// 已经建立起来的辨识度丢掉。
public enum SummaryChip: Hashable, Sendable {
...
public let energyLabels = ["A+++", "A++", "A+", "A", "B", "C", "D", "E", "F"]
