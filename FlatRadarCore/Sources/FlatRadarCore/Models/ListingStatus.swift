...
public nonisolated enum ListingStatus: String, CaseIterable, Identifiable, Sendable {
    case book
    case lottery
    case reserved
    case other
    ...
    public static func from(_ raw: String?) -> ListingStatus {
    ...
    public var label: String {
        switch self {
        case .book:     return String(localized: "Direct book", bundle: .module)
        case .lottery:  return String(localized: "Lottery", bundle: .module)
        case .reserved: return String(localized: "Reserved", bundle: .module)
        case .other:    return String(localized: "Unknown status", bundle: .module)
    ...
    public static let byPriority: [ListingStatus] = [.book, .lottery, .reserved, .other, .occupied]

    public var priority: Int { Self.byPriority.firstIndex(of: self) ?? Self.byPriority.count }
}
